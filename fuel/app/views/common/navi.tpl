<div class="col-xs-2 sidebar">
	<ul class="nav nav-sidebar list-group">
		...
		<li class="list-group-item">
  		...
  		<li class="list-group-item">
    		<a data-toggle="collapse" href="#menu3" class="accordion-title">鍵開け依頼<span id="home_badge" class="badge text-right">2</span></a>
    		<div id="menu3" class="panel-collapse collapse accordion-body">
      			<div class="panel-body">
        			<ul class="list-group">
        				<li class="list-group-item"><a href="/request/regist/list">依頼書作成</a></li>
          				<li class="list-group-item"><a href="/request/approve/list">依頼書承認<span id="home_badge" class="badge text-right">2</span></a></li>
		...
		<li class="list-group-item">
    		...
    		<div id="menu4" class="panel-collapse collapse accordion-body">
      			<div class="panel-body">
        			<ul class="list-group">
        				<li class="list-group-item"><a href="/operator/list">照会 / 変更</a></li>
          				<li class="list-group-item"><a href="/operator/input">作成</a></li>
        			</ul>
      			</div>
    		</div>
  		</li>
  		...
  		<li class="list-group-item">
    		...
    		<div id="menu9" class="panel-collapse collapse accordion-body">
      			<div class="panel-body">
        			<ul class="list-group">
        				<li class="list-group-item"><a href="/network/list">照会 / 変更</a></li>
          				<li class="list-group-item"><a href="/network/input">作成</a></li>
        			</ul>
      			</div>
    		</div>
  		</li>
